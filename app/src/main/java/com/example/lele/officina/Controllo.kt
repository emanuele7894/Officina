...
class Controllo : AppCompatActivity() {
        ...
        nextPage.setOnClickListener(object : View.OnClickListener {
            ...
            prevPage.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View?) {
                    ...
                    numPage.text = "1"
                    content_controllo_print.visibility = View.VISIBLE
                    content_controllo_print2.visibility = View.INVISIBLE
    ...
    fun saveImage(bitmap: Bitmap, bitmap2: Bitmap, stringa: String) {
        ...
        val fname = "PrintControlloP1.jpg"
            val fname2 = "PrintControlloP2.jpg"
